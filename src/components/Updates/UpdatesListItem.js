  ...
  return (<React.Fragment><li className="update-list-item">
    ...
    <aside className="update-list-item--info">
      ...
      <div className="update-list-item--numbers">
        <span className="color-warning"><i className="fas fa-radiation-alt"></i> Terkonfirmasi : {update.totalConfirmed}</span><span className="color-success"> <i className="fas fa-heartbeat"></i> Sembuh: {update.totalRecovered}</span></div>
